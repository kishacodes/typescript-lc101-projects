...
// console.log(
//   `The spacecraft ${spacecraftName} will take ${spaceShuttle.getDaysToLocation(
//     kilometersToMars
//   )} days to to travel to Mars.`
// );
// console.log(
//   `It takes ${spaceShuttle.name} ${spaceShuttle.getDaysToLocation(
//     kilometersToTheMoon
//   )} days to arrive at the Moon.`
// );
